  ...
  neigh_stride(-1.)
{
  ...
  if(myname!="RMSD"&&myname!="CONTACTMAP"&&myname!="DISTANCE"&&myname!="PIV"&&myname!="PIVS") error("One or more of your arguments is not of RMSD/CONTACTMAP/DISTANCE/PIV type!!!");
