...
With the VOLUME keyword one scales the atom-atom distances by the cubic root of the ratio between the average volume of all the reference pdb and the box volume of the initial step of the trajectory file.
...
private:
  ...
  Vector distanceAB (
         ...
         const Vector& B);
  /**
   * compute distance between two PIV
   */
  double distanceAB (
